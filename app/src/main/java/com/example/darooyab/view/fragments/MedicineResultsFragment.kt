...
class MedicineResultsFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        medicineList.add(Medicine(4,"Acetaminophen", "استامینوفن", "120mg","شربت"))
        medicineList.add(Medicine(5,"Acetaminophen", "استامینوفن", "100mg","قطره"))
        medicineList.add(Medicine(6,"Acetaminophen", "استامینوفن", "75mg","شیاف"))
        medicineList.add(Medicine(7,"Acetaminophen", "استامینوفن", "125mg","شیاف"))
        medicineList.add(Medicine(8,"Acetaminophen", "استامینوفن", "325mg","شیاف"))
        medicineList.add(Medicine(9,"Ibuprofen", "بروفن", "200mg","قرص"))
        medicineList.add(Medicine(10,"Ibuprofen", "بروفن", "400mg","قرص"))
        medicineList.add(Medicine(11,"Cefixime", "سفکسیم", "200mg","قرص"))
        medicineList.add(Medicine(12,"Cefixime", "سفکسیم", "400mg","قرص"))
